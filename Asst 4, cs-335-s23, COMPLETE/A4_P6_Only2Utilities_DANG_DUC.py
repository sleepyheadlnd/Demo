...
#
# returns (maximum utility value, action to get that utility, num nodes visited)
#
# STOPS WHEN FINDS FIRST VALUE OF 1
...
#          numNodes = number of nodes examined (including the current node) to determine this
#
# returns (minimum utility value, action to get that utility, num nodes visited)
#
# STOPS WHEN FINDS FIRST VALU OF 0
